...
<body>
	...
	<div class="container">
		...
		<h2>Annual Revenue for ${carName}</h2>
		<table>
			<tr>
				<th>Year</th>
				<th>Revenue</th>
			</tr>
			<c:forEach items="${annualRevenueListByCar}" var="annualRevenue">
				<tr>
					<td>${annualRevenue.Year}</td>
					<td>${annualRevenue.Revenue}</td>
				</tr>
			</c:forEach>
		</table>
<br>
    ...
    <form action="/ProdEnquriyManagementSystem/annualRevenueByCar" method="get">
